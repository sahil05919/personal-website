...
/*
  DASHES. This file used tight em dashes ("distraction—something") in four
  places; every other page on the site sets a parenthetical with a spaced em
  dash ("he bought hard — he travelled to Surat"). Two conventions in one book
  is the sort of thing a reader feels without being able to name. Normalised to
  the site's own.
*/
export const intro =
